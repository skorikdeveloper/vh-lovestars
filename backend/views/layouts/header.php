...
<header class="main-header">
    <?= Html::a('<span class="logo-mini">LC</span><span class="logo-lg">' . Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p class="user-info-p text-secondary">
                                <?php if (Yii::$app->user->identity['role'] == 'admin') : ?>
                                    Administrator
                                <?php elseif(Yii::$app->user->identity['role'] == 'user'): ?>
                                    User
                                <?php else:?>
                                    ...
                                <?php endif; ?>
...
<!--                                --><?php //if (Yii::$app->user->identity['role'] == 'admin') : ?>
<!--                                    Administrator-->
<!--                                --><?php //elseif(Yii::$app->user->identity['role'] == 'moder'): ?>
<!--                                    Модератор-->
<!--                                --><?php //else:?>
<!--                                    Пользователь-->
<!--                                --><?php //endif; ?>
...
<!--                                E-mail-->
<!--                            </div>-->
<!--                            <div class="col-xs-12 text-success" style="text-indent:15px;">-->
<!--                                --><?php //if (Yii::$app->user->identity['email'] != '') : ?>
<!--                                    --><?//= Yii::$app->user->identity['email']?>
<!--                                --><?php //else:?>
