...
use app\models\LovestarTransaction;
 ...
 */
class LovestarTransactionController extends AppController
{
    /**
     * @inheritdoc
     */
    ...
    {
      $query = LovestarTransaction::find();
	  if(!empty(Yii::$app->request->get())) $query = LovestarTransaction::filterLovestarTransaction();

      $this->setMeta('Lovestar Transaction');
...
//
    ...
    public function actionCreate()
    {
		...
		if (
			...
			echo "</pre>";
			exit;
//			$new_action_status = LovestarTransaction::createAction($model->ruleId, $model->emittedLovestarsUser);
